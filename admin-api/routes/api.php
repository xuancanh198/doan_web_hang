    ...
    Route::middleware(['admin.checkPermisstion'])->group(function () {
        ...
        Route::group(['prefix' => 'product'], function () {
            ...
            Route::group(['prefix' => 'product'], function () {
                ...
                Route::put('/update-import-export/{id}', [ProductController::class, 'updateImportExport']);
                Route::get('/{id}', [ProductController::class, 'show']);
                Route::get('/view-import-export/{id}', [ProductController::class, 'showImportExport']);
                Route::get('/view-log/{id}', [ProductController::class, 'showLog']);
                Route::put('/{id}', [ProductController::class, 'update']);
                Route::delete('/{id?}', [ProductController::class, 'destroy']);
                Route::delete('/delete-import-export/{id}', [ProductController::class, 'destroyImportExport']);
            });
        });
