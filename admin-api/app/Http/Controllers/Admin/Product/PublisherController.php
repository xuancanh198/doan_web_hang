...
use App\Services\Functions\Execute\Product\Publisher\PublisherServiceInterface;
use App\Http\Requests\PublisherRequest;
use App\Http\Resources\PublisherAdminResource;
...
class PublisherController extends Controller
{
    ...
    public function __construct(PublisherServiceInterface $service, PublisherRequest $request)
    {
    ...
    public function index()
    {
        ...
        return $this->handleRequest(function () {
            ...
            return $this->returnResponseBase(PublisherAdminResource::class, $this->request, $result);
        });
    }
