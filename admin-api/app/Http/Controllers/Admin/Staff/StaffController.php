...
use App\Services\Functions\Execute\Staff\Staff\StaffServiceInterface;
use App\Http\Requests\StaffRequest;
use App\Http\Resources\StaffAdminResource;
...
class StaffController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->handleRequest(function () {
            ...
            return $this->returnResponseBase(StaffAdminResource::class, $this->request, $result);
        });
    }
