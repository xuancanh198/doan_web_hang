...
use App\Services\Functions\Execute\Permisstion\PermisstionDetail\PermisstionDetailServiceInterface;
use App\Http\Requests\PermisstionDetailRequest;
use App\Http\Resources\PermisstionAdminResource;
...
class PermisstionDetailController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->handleRequest(function () {
            ...
            return $this->returnResponseBase(PermisstionAdminResource::class, $this->request, $result);
        });
    }
