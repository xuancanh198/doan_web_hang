...
namespace App\Services\Functions\Execute\Permisstion\Action;

use App\Repositories\Permisstion\Action\ActionRepositoryInterface;
use App\Enums\BaseRequestAttribute;
use App\Http\Resources\ActionDetailResource;
...
class ActionService implements ActionServiceInterface
{
    ...
    {
        return new ActionDetailResource($this->repository->findViewDetail($id));
    }
}
