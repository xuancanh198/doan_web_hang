...
namespace App\Services\Functions\Execute\Permisstion\Permisstion;

use App\Repositories\Permisstion\Permisstion\PermisstionRepositoryInterface;
...
class PermisstionService implements PermisstionServiceInterface
{
    ...
    public function __construct(PermisstionRepositoryInterface $repository)
    {
