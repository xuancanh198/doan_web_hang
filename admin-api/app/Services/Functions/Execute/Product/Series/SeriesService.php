...
namespace App\Services\Functions\Execute\Product\Series;

use App\Repositories\Product\Series\SeriesRepositoryInterface;
...
class SeriesService implements SeriesServiceInterface
{
    ...
    {
        return new SeriesDetailResource($this->repository->findViewDetail($id));
    }
