...
import { createAuthor } from "@/lib/callAPI/ServiceReduxCallAPI";
import { useTranslations } from "next-intl";
import { getDataAuthorServer } from "@/lib/callAPI/ServiceReduxCallAPI"
...
export default function DefaultInputs() {
  ...
  const createData = async (values: any, resetForm: () => void) => {
    ...
    const data = await dispatch(createAuthor(formData));
  ...
  return (
    <ComponentCard title={t('Base.CreateTitle', { field: t('Page.author') })}>
      <Formik
        initialValues={{
          code: "",
          name: "",
