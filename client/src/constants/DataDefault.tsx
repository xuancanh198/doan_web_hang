...
export const ARRAY_Object_DEFAULT: object[] = [];
export const PAGE_DEFAULT: number = 1;
export const Number_Zero_DEFAULT: number = 0;
export const LIMIT_DEFAULT : number = 10;
export const NULL_VALUE_DEFAULT : null = null;
export const FALSE_VALUE_DEFAULT : boolean = false;
